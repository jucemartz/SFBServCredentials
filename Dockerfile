...
RUN $JAVA_HOME/bin/keytool -import -noprompt -v -trustcacerts -alias ldap_ula -file /app/SFBServCredentials/certificate/kerberos-ulaalumnos.int.cer -keystore $JAVA_HOME/jre/lib/security/cacerts -keypass changeit -storepass changeit
